...
description: "Illustrative Setia Alam sub-sale renovation case study with BINA+ Design & Build — numbers from real Klang Valley quotes, property details are composites."
...
faqs:
  ...
  - q: "Who was the contractor?"
    a: "BINA+ Design & Build, based in Shah Alam. We picked them because their carpentry is in-house (Setia Alam is 12 minutes from their workshop), they gave us an itemised quote on the second site visit, and the same project lead (Najiha) ran the job from sketch to handover. Their published renovation packages are at /packages/."
includeBinaCta: true
---
...
<figure class="not-prose my-12">
  <div class="relative overflow-hidden bg-paper-deep aspect-[16/9]">
    <img
      src="https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?auto=format&fit=crop&w=1600&q=80"
      alt="Empty Malaysian terrace house interior, original developer tiles, late afternoon light"
      loading="lazy"
      decoding="async"
