...
tags: ["vetting", "red flags", "klang valley"]
faqs:
  - q: "What's the single biggest red flag in a Malaysian renovation contractor?"
    a: "Refusal to provide an itemised quote. If the only number on the page is a lump sum, walk away. Itemised quotes prove the contractor has actually costed your scope — and they make variation orders honest later."
  - q: "Should I always ask for the contractor's CIDB green card?"
    a: "Yes — and ask to see the actual card, not a screenshot. Anyone doing structural or M&E work in Malaysia legally needs CIDB registration. Most homeowners never check, which is exactly why bad contractors keep operating."
  - q: "How much deposit is too much?"
    a: "More than 20% upfront before any site mobilisation is a red flag. The standard is 10–15% on signing, with the next progress payment tied to a measurable milestone."
includeBinaCta: true
---
